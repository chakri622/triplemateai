...
if __name__ == "__main__":
        ...
        user_query = "I want to travel from Austin to Tokyo next month. Find me the best flights and hotels."
        res=run_travel_agent(user_query,thread_id="test_thread_001")
        print("Result:", res)
